      ...
      <table align="center" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
        <tr>
          <td align="center" style="padding: 0 32px;">
            ...
            <p style="margin: 8px 0 0 0; font-family: ${FONT_FAMILY}; font-size: 12px; ${labelStyle(s1)}">Porudžbina primljena</p>
          </td>
          <td style="width: 60px; border-bottom: 2px solid ${STYLES.border};"></td>
          <td align="center" style="padding: 0 32px;">
            <div style="width: 36px; height: 36px; border-radius: 50%; ${stepStyle(s2)} line-height: 36px; text-align: center; font-family: ${FONT_FAMILY}; font-size: 14px; margin: 0 auto;">2</div>
            <p style="margin: 8px 0 0 0; font-family: ${FONT_FAMILY}; font-size: 12px; ${labelStyle(s2)}">Porudžbina u obradi</p>
          </td>
          <td style="width: 60px; border-bottom: 2px solid ${STYLES.border};"></td>
          <td align="center" style="padding: 0 32px;">
            <div style="width: 36px; height: 36px; border-radius: 50%; ${stepStyle(s3)} line-height: 36px; text-align: center; font-family: ${FONT_FAMILY}; font-size: 14px; margin: 0 auto;">${s3 ? "✓" : "3"}</div>
            <p style="margin: 8px 0 0 0; font-family: ${FONT_FAMILY}; font-size: 12px; ${labelStyle(s3)}">Porudžbina je potvrđena i poslata</p>
          </td>
        </tr>
      </table>
    </td>
