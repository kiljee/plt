...
<table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
  <tr>
    <td style="padding: 24px; background-color: ${STYLES.bgLight};">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
        <tr>
          <td style="padding: 4px 0; font-family: ${FONT_FAMILY}; font-size: 15px; font-weight: bold; color: ${STYLES.primary};">
            Iznos za uplatu
          </td>
          <td align="right" style="padding: 4px 0; font-family: ${FONT_FAMILY}; font-size: 15px; font-weight: bold; color: ${STYLES.primary};">
